<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowSizeCode.aspx.cs" Inherits="cfoa.ShowSizeCode" %>
...
<body style="background-color:#FAEBD7">
    ...
    <asp:Textbox id="txtSize" Text="" Width="60px" Height ="20px" Font-Size="11px"  runat="server"/>
    ...
    <asp:GridView ID="gvDetails" runat="server" Height="90px" Width="600px" 
      ...
      onpageindexchanging="gvDetails_PageIndexChanging">
        <Columns>
            ...
            <asp:BoundField DataField="englishname" HeaderText="英文描述(English Name)" >
            <ItemStyle Width="60px" />
            </asp:BoundField>
        </Columns>
