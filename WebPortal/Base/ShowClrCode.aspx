<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowClrCode.aspx.cs" Inherits="cfoa.ShowClrCode" %>
...
<body style="background-color:#FAEBD7">
    ...
    <div>
    <asp:Label id="lblClr" Text="Color(顏色)" Width="72px" Height ="20px" Font-Size="11px"  runat="server"/>
    <asp:Textbox id="txtClr" Text="" Width="60px" Height ="20px" Font-Size="11px"  runat="server"/>
    ...
    <asp:Button id="btnFind" Text="Find" OnClick="btnFind_Click" Width="80px" Height ="30px" Visible="true"  runat="server"/>
    <asp:GridView ID="gvDetails" runat="server" Height="90px" Width="600px" 
      ...
      onpageindexchanging="gvDetails_PageIndexChanging">
        <Columns>
            ...
            <asp:BoundField DataField="do_color" HeaderText="顏色做法(English Name)" >
            <ItemStyle Width="60px" />
            </asp:BoundField>
        </Columns>
