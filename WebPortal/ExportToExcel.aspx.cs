...
namespace WebPortal
{
    public partial class ExportToExcel : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string filename = System.Web.HttpUtility.UrlEncode(HttpUtility.HtmlEncode(Request["txtName"]), System.Text.Encoding.UTF8);
            ...
            Response.AppendHeader("content-disposition", "attachment;filename=\"" + HttpUtility.HtmlEncode(filename ?? DateTime.Now.ToString("yyyyMMdd")) + ".xls\"");
