$(function () {
    ...
    $('#dg').datagrid({
        ...
        columns: [[
            ...
            {
                field: 'invoice_date', title: 'Date', width: 120, editor: {
                    type: 'validatebox',
            ...
            {
                field: 'invoice_id', title: 'Invoice', width: 120, editor: {
                    type: 'validatebox',
            ...
            {
                field: 'mo_id', title: 'Mo', width: 120, editor: {
                    type: 'validatebox',
                ...
                field: 'custcode', title: 'Cust Code', width: 120, editor: {
                    type: 'validatebox',
                ...
                field: 'brand', title: 'brand', width: 120, editor: {
                    type: 'validatebox',
            ...
            {
                field: 'report_no', title: 'Report No', width: 160, editor: {
                    type: 'validatebox',
            ...
            {
                field: 'curr', title: 'Curr', width: 40, editor: {
                    type: 'validatebox',
                    options: {
                        required: true,
                    },
            ...
            {
                field: 'amount', title: 'Amount', width: 120, editor: {
                    type: 'validatebox',
                    options: {
                        required: true,
                    },
            ...
            {
                field: 'ref_report', title: 'Own Reference Report', width: 260, editor: {
                    type: 'validatebox',
                    options: {
                        required: true,
                    },
