<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sa_Sample_Trace.aspx.cs" Inherits="WebPortal.Sales.Sa_Sample_Trace" %>
...
<body style="background-color:#E4EEF3">
    <div id="container">  
   ...
   <%-- <table class="table_SiteMapPath">
    ...
    <div id="Div2" style="width:98%; height:440px; overflow:scroll;overflow-y:scroll;" runat="server">
    <table style="table-layout:fixed;word-wrap:break-word;word-break:break-all;" width="850px" border="2">
    <tr>
    <td colspan="2">
    ...
    <tr>
    <td colspan="2" style="background-color: #C0C0C0; line-height: 32px;">

    <asp:Label id="lblShowNew" Text="發卡部門填寫：" Width="120px" Height ="30px" ForeColor="Blue"  runat="server"/>
    <asp:Label ID="lblAction_type" Height ="30px" runat="server" Text="操作方式" Width="68px" />
    <asp:DropDownList ID="dlAction_type" runat="server" Height ="30px" Width="124px" 
    ...
    <div id="dvMerge" style="width:98%; height:120px; overflow:scroll;overflow-y:scroll;" runat="server" >
    <table style="table-layout:fixed;word-wrap:break-word;word-break:break-all;" width="850px" border="2">
    <tr>
    <td>
    ...
    <asp:DropDownList ID="dlOwnDep" runat="server" Height ="25px" Width="226px" />
...
<RowStyle Height="20px"></RowStyle>
    ...
    <div id="Div1" style="width:98%; height:180px; overflow:scroll;overflow-y:scroll;" runat="server" >
    <table style="table-layout:fixed;word-wrap:break-word;word-break:break-all;" width="850px" border="2">
    <tr>
    <td style="background-color: #C0C0C0; line-height: 32px;">

    <asp:Label id="lblShowTrace" Text="跟進部門填寫：" Width="120px" Height ="30px" ForeColor="Blue"  runat="server"/>
    <asp:Label ID="lblAction_type1" runat="server" Text="操作方式" Width="68px" Height ="30px" />
    ...
    <asp:TextBox ID="txtOutDate" runat="server" Text="" Height ="20px" Width="160px" />
    </div>
    ...
    <div id="Div3" style="width:98%; height:200px; overflow:scroll;overflow-y:scroll;" runat="server" >
    <table style="table-layout:fixed;word-wrap:break-word;word-break:break-all;" width="850px" border="2">
    <tr>
    <td>
