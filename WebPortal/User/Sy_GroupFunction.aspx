<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sy_GroupFunction.aspx.cs" Inherits="WebPortal.User.Sy_GroupFunction" %>
    ...
    <script type="text/javascript">
        ...
        function initList(queryData) {
            $('#dg').datagrid({
                ...
                url: "../ashx/Ax_UserGroupManager.ashx/GetItem?edit_mode=loadgroupfunc",   //指向后台的Action来获取当前用户的信息的Json格式的数据
                ...
                { field: 'orderseq', title: '序號', width: 80 },
                { field: 'AuthorityID', title: '功能編號', width: 80 },
                { field: 'AuthorityName', title: '功能描述', width: 160 },
                { field: 'TypeID', title: '所屬組別', width: 60 },
                { field: 'func_name', title: '組別描述', width: 100 }
                ]],
        ...
        function UpdateList() {
            ...
            var checkedItems = $('#dg').datagrid('getChecked');
             $.each(checkedItems, function (index, item) {
                ...
                j.authorityid = item.AuthorityID;
                j.typeid = item.TypeID;
                json.push(j);
            });


            var obja = JSON.stringify(json);
            var url = "../ashx/Ax_UserGroupManager.ashx/GetItem?edit_mode=updategroupfunc";
            $.ajax({
                url: url,
                type: "post",
                data: { 'param': obja }, //参数
        ...
        <div class="easyui-layout" id="tb" style="padding: 0px; height: auto">--%>
            <!-------------------------------搜索框----------------------------------->
                    ...
                    <div style="margin-bottom: 5px">
                        ...
                        <input type="text" class="easyui-validatebox" id="txtGroupName" name="txtGroupName" style="width:220px" />&nbsp; 
                        <a href="#" class="easyui-linkbutton" iconcls="icon-save" id="btnSave" style="width:100px;height:25px">儲存</a>
                    </div>
