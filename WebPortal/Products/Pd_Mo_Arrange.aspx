<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pd_Mo_Arrange.aspx.cs" Inherits="WebPortal.Products.Pd_Mo_Arrange" %>
    ...
    <tbody>
        ...
        <ItemTemplate>
           <tr>
               ...
               <%--<td style="visibility:hidden"><%#Eval("arrange_id")%></td>--%>
               <td><input type="checkbox" value="<%#Eval("arrange_id")%>" onclick="rep(this)" />安排</td>
            	...
            	<td><%#Eval("arrange_date")%></td>
            	<%--<td><%#Eval("urgent_status")%></td>--%>

                <td><select style="width:90%">
                        <option value="<%#Eval("mo_urgent")%>"><%#Eval("mo_urgent")%></option>
                        <option value="01"></option>
                        <option value="02">急單</option>
                        <option value="03">特急</option>
                        <option value="04">超特急</option>
                        </select>
                    </td>
                <td><%#Eval("prd_item")%></td>
                <td><%#Eval("cust_o_date")%> </td>
                <td><%#Eval("req_f_date").ToString()%></td>
    		    <%--<td><%# Eval("order_qty")%></td>--%>
                <td><input type="text" name="colOrder_qty" style="width:80%" value="<%#Eval("order_qty")%>"/></td>
                <td><%# Eval("req_qty")%></td>
                <td><%# Eval("cpl_qty")%></td>
                <td><%# Eval("arrange_qty")%></td>
                <td><%# Eval("prd_cpl_qty")%></td>
                <td><%# Eval("dep_rep_date")%></td>
                <td><%# Eval("arrange_machine")%></td>

                <td><%#Eval("now_date")%>
            	
            	</td>
               <td><%# Eval("worker_gp")%></td>
            	<td>
            	<%#Eval("prd_dep")%>
