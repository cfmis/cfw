...
<body>
    ...
    <table style="table-layout:fixed;word-wrap:break-word;word-break:break-all;" border="2" width="480px">
    <tr>
    <td> 
    <asp:Button class="btn btn-success" id="btnFind" Text="查找" OnClick="btnFind_Click" Width="120px" Height ="30px"  runat="server"/>
    </td>
    <td>
    <button class="btn btn-success" style="width:120px" onclick ="javascript:getXlsFromTbl(window.open(),'tableDetail','divDetail',1);">Excel Export</button>
    </td>
    <td>
    <asp:Button class="btn btn-success" id="btnFindSample" Text="查找樣辨登記表" Width="120px" Height ="30px" OnClick="btnFindSample_Click"  runat="server"/>
    </td>
    <td>
    <button class="btn btn-success" style="width:120px" onclick ="javascript:getXlsFromTbl(window.open(),'tableDetail','divDetail',2);">樣辨登記表</button> 
    </td>
    </tr>
    </table>
    <div id="Div1" class="div_search_frame" runat="server">
    <table style="table-layout:fixed;word-wrap:break-word;word-break:break-all;" border="2" width="800px">
    <tr>
    <td>
    ...
    <td style="width:10%">
    <asp:Label id="lblDate1" Text="建立日期" Width ="90%" runat="server"/>
    </td>
    <td style="width:20%">
