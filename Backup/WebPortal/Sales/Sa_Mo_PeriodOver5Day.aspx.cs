...
{
    public partial class Sa_Mo_PeriodOver5Day : BasePage//System.Web.UI.Page
    {
        ...
        private void ExportToExcel(string filename, string content, string cssText)
        {
            ...
            res.ContentEncoding = System.Text.Encoding.GetEncoding("Big5");// System.Text.Encoding.UTF8//繁體
