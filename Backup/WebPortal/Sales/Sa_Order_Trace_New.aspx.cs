...
namespace WebPortal.Sales
{
    public partial class Sa_Order_Trace_New : BasePage//System.Web.UI.Page
    {
        ...
        protected void loadData(int source_type)
        {
            ...
            //list = Leyp.SQLServerDAL.Sales.Factory_New.SalesQueryPublicDAL().getOrderTraceList(source_type, user_id, sales_group
            ...
            //list = Leyp.SQLServerDAL.Sales.Factory.getSalesReturnDAL().getSearchList("", "", 0);

            //txtCust1.Text = list[0].id;
            ...
            this.OrderList.DataSource = dtOc.DefaultView;
