...
<body>
    ...
    <td>
    <asp:DropDownList ID="dlApproveColor" Width ="140px" runat="server" ><%-- AutoPostBack="true"--%>
    ...
    <tr>
    <td>--%>
    <asp:GridView ID="gvMo" runat="server" Height="90px" Width="1000px"
...
<HeaderStyle Width="120px"></HeaderStyle>
            ...
            <asp:ButtonField Text="批色" CommandName="Approve_color" HeaderStyle-Width="60px" />
        </Columns>
